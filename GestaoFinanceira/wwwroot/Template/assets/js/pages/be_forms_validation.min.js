...
( {
    ...
    , 19:function(e, r) {
        ...
        var l=function() {
                ...
                key:"initValidationBootstrap", value:function() {
                    jQuery(".js-validation-bootstrap").validate( {
                        ...
                        , messages: {
                            ...
                            , "val-select2":"Please select a value!", "val-select2-multiple":"Please select at least 2 values!", "val-suggestions":"What can we do to become better?", "val-skill":"Please select a skill!", "val-currency":"Please enter a price!", "val-website":"Please enter your website!", "val-phoneus":"Please enter a US phone!", "val-digits":"Please enter only digits!", "val-number":"Please enter a number!", "val-range":"Please enter a number between 1 and 5!", "val-terms":"You must agree to the service terms!"
                        }
                    }
                    )
                }
            ...
            , {
                key:"initValidationMaterial", value:function() {
                    jQuery(".js-validation-material").validate( {
                        ...
                        , rules: {
                            ...
                            , "val-confirm-password2": {
                                required: !0, equalTo: "#val-password2"
                            }
                            , "val-select22": {
                                required: !0
                            }
                        ...
                        , messages: {
                            ...
                            , "val-email2":"Please enter a valid email address", "val-password2": {
                                required: "Please provide a password", minlength: "Your password must be at least 5 characters long"
                            }
                            , "val-confirm-password2": {
                                required: "Please provide a password", minlength: "Your password must be at least 5 characters long", equalTo: "Please enter the same password as above"
                            }
                            , "val-select22":"Please select a value!", "val-select2-multiple2":"Please select at least 2 values!", "val-suggestions2":"What can we do to become better?", "val-skill2":"Please select a skill!", "val-currency2":"Please enter a price!", "val-website2":"Please enter your website!", "val-phoneus2":"Please enter a US phone!", "val-digits2":"Please enter only digits!", "val-number2":"Please enter a number!", "val-range2":"Please enter a number between 1 and 5!", "val-terms2":"You must agree to the service terms!"
                        }
                    }
                    )
                }
